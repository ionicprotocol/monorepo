...
export const CreatePoolConfiguration = () => {
  ...
  const { bgColor, borderColor, solidBtnTextColor, dividerColor, solidBtnActiveBgColor } =
    useColors();
  ...
  return chainId ? (
    <Box alignSelf={'center'} width={'100%'} mx="auto" mt="8%" mb={8}>
      ...
      <Center>
        <Button
          ...
          _hover={{ opacity: 0.8 }}
        >
          <Center color={solidBtnTextColor} fontWeight="bold">
    ...
    <Center height="50vh" width="100%" color="#FFFFFF">
      <Spinner />
    </Center>
  );
};

const OptionRow = ({ children, ...others }: { children: ReactNode; [key: string]: any }) => {
  return (
    <Row
