...
import CaptionedStat, { CaptionedStatProps } from '@components/shared/CaptionedStat';
...
type APYWithRefreshMovingProps = Omit<Omit<APYMovingStatProps, 'interval'>, 'startingAmount'> &
