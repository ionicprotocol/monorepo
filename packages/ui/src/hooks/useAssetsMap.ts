...
import { AssetHash, createAssetsMap, createTokensDataMap, TokensDataHash } from '@utils/tokenUtils';
...
export const useAssetsMapWithTokenData = (
  ...
  const assetsArrayWithTokenData: USDPricedFuseAssetWithTokenData[][] | null = useMemo(
    () =>
