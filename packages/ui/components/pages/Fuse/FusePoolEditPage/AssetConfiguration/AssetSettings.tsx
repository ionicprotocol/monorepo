...
export const AssetSettings = ({
  ...
  useEffect(() => {
    // setValue('collateralAsset', borrowCapsState ? borrowCapsState.borrowCap : 0);
    console.log('setValue collateralAsset');
  ...
  const setBorrowCapsDefault = () => {
    setValue('borrowCap', borrowCapsState ? borrowCapsState.borrowCap : 0);
            ...
            >
              {isEditBorrowCap ? (
                <>
                  <Button
                    type="submit"
                    disabled={isUpdating || watchBorrowCap === borrowCapsState?.borrowCap}
                  >
                    Save
                  </Button>
