...
export function useColors() {
  const cPage = {
    primary: {
      ...
      hoverColor: useColorModeValue(
        COLOR_PALETTE.ecru30alpha,
        COLOR_PALETTE.ecru30
      ),
      txtColor: useColorModeValue(
        COLOR_PALETTE.raisinBlack,
        COLOR_PALETTE.whiteBg
      )
    },
    secondary: {
      ...
      dividerColor: useColorModeValue(
        COLOR_PALETTE.gunmetal80,
        COLOR_PALETTE.ecru80
      ),
      txtColor: useColorModeValue(
        COLOR_PALETTE.raisinBlack,
        COLOR_PALETTE.raisinBlack
  ...
  const cSolidBtn = {
    primary: {
      bgColor: useColorModeValue(COLOR_PALETTE.ecru, COLOR_PALETTE.ecru),
      hoverBgColor: useColorModeValue(
        COLOR_PALETTE.ecru80,
        COLOR_PALETTE.ecru80
      ),
      hoverTxtColor: useColorModeValue(
        COLOR_PALETTE.raisinBlack,
        COLOR_PALETTE.raisinBlack
      ),
      txtColor: useColorModeValue(
  ...
  const cOutlineBtn = {
    primary: {
      ...
      selectedBgColor: useColorModeValue(
        COLOR_PALETTE.ecru,
        COLOR_PALETTE.ecru
      ),
      selectedTxtColor: useColorModeValue(
        COLOR_PALETTE.raisinBlack,
        COLOR_PALETTE.raisinBlack
      ),
  ...
  const cCard = {
    ...
    headingBgColor: useColorModeValue(
      COLOR_PALETTE.ecru30alpha,
      COLOR_PALETTE.ecru30
    ),
    hoverBgColor: useColorModeValue(
      COLOR_PALETTE.ecru10alpha,
      COLOR_PALETTE.ecru10
    ),
  ...
  const cInput = {
    ...
    borderColor: cPage.primary.borderColor,
    placeHolderTxtColor: useColorModeValue(
      COLOR_PALETTE.silverMetallic,
      COLOR_PALETTE.white50
    ),
    txtColor: useColorModeValue(COLOR_PALETTE.raisinBlack, COLOR_PALETTE.white)
  };
  ...
  const cSlider = {
    filledTrackBgColor: useColorModeValue(
      COLOR_PALETTE.ecru,
      COLOR_PALETTE.ecru
    ),
    thumbBgColor: useColorModeValue(
      COLOR_PALETTE.raisinBlack,
      COLOR_PALETTE.ecru
    ),
