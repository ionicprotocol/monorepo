    ...
    function setUp() public {
        ...
        emissionsManager = EmissionsManager(
            address(
                ...
                abi.encodeWithSelector(emissionsManager.initialize.selector, PoolDirectory(address(poolDirectory)), protocolAddress, rewardToken, collateralBp, nonBlacklistableBytecode)
                )
            )
        );
