...
const DEFAULT_STATIC_TOKEN_LIQUIDITY = BigNumber.from(2);
const DEFAULT_STATIC_QUOTE_TOKEN_LIQUIDITY = BigNumber.from(3);
...
describe("ManagedPeriodicPriceAccumulationOracle#update", function () {
    var oracle;
    ...
    beforeEach(async () => {
        ...
        // Deploy oracle
        const oracleFactory = await ethers.getContractFactory("ManagedPeriodicPriceAccumulationOracle");
...
describe("ManagedPeriodicPriceAccumulationOracle#supportsInterface(interfaceId)", function () {
    var oracle;
    var interfaceIds;
