...
export interface WithdrawableFlywheelStaticRewardsInterface
...
export interface WithdrawableFlywheelStaticRewards extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WithdrawableFlywheelStaticRewardsInterface;
