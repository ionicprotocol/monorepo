...
import type {
  ICErc20Plugin,
  ICErc20PluginInterface,
} from "../../CTokenInterfaces.sol/ICErc20Plugin";
...
export class ICErc20Plugin__factory {
  static readonly abi = _abi;
  static createInterface(): ICErc20PluginInterface {
    return new utils.Interface(_abi) as ICErc20PluginInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ICErc20Plugin {
    return new Contract(address, _abi, signerOrProvider) as ICErc20Plugin;
  }
}
