...
export interface WSTEthPriceOracleInterface extends utils.Interface {
  functions: {
...
export interface WSTEthPriceOracle extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WSTEthPriceOracleInterface;
