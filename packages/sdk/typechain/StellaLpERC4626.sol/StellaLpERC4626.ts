...
export interface StellaLpERC4626Interface extends utils.Interface {
  functions: {
    ...
    "assetsAsArray(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "assetsAsArray",
    values: [BigNumberish]
  ): string;
...
export interface StellaLpERC4626 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StellaLpERC4626Interface;
  ...
  assetsAsArray(arg0: BigNumberish, overrides?: CallOverrides): Promise<string>;
  ...
  callStatic: {
    ...
    reinitialize(_wNative: string, overrides?: CallOverrides): Promise<void>;
