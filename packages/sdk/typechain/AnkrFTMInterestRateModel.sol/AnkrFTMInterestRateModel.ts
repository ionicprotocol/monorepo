...
export interface AnkrFTMInterestRateModelInterface extends utils.Interface {
  functions: {
...
export interface AnkrFTMInterestRateModel extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AnkrFTMInterestRateModelInterface;
