...
export interface CompoundMarketERC4626Interface extends utils.Interface {
  functions: {
    ...
    "weightedAprAfterDeposit(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "weightedAprAfterDeposit",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "ClaimedVaultRewards(address,address,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "ClaimedVaultRewards"): EventFragment;
...
export interface ClaimedVaultRewardsEventObject {
  rewardToken: string;
  vault: string;
  amount: BigNumber;
}
export type ClaimedVaultRewardsEvent = TypedEvent<
  [string, string, BigNumber],
  ClaimedVaultRewardsEventObject
>;

export type ClaimedVaultRewardsEventFilter =
  TypedEventFilter<ClaimedVaultRewardsEvent>;
...
export interface CompoundMarketERC4626 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CompoundMarketERC4626Interface;
  ...
  callStatic: {
    ...
    reinitialize(registry_: string, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    "ClaimedVaultRewards(address,address,uint256)"(
      rewardToken?: string | null,
      vault?: string | null,
      amount?: null
    ): ClaimedVaultRewardsEventFilter;
    ClaimedVaultRewards(
      rewardToken?: string | null,
      vault?: string | null,
      amount?: null
