...
export interface BombERC4626Interface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: "xbomb", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "xbomb", data: BytesLike): Result;
...
export interface BombERC4626 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BombERC4626Interface;
  ...
  functions: {
    ...
    xbomb(overrides?: CallOverrides): Promise<[string]>;
  };
  ...
  estimateGas: {
    ...
    xbomb(overrides?: CallOverrides): Promise<BigNumber>;
  };
  ...
  populateTransaction: {
    ...
    xbomb(overrides?: CallOverrides): Promise<PopulatedTransaction>;
  };
}
