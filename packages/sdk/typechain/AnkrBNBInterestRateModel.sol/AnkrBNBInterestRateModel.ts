...
export interface AnkrBNBInterestRateModelInterface extends utils.Interface {
  functions: {
    "ANKR_BOND()": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "ANKR_BOND", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "ANKR_BOND", data: BytesLike): Result;
...
export interface AnkrBNBInterestRateModel extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AnkrBNBInterestRateModelInterface;
  ...
  functions: {
    ANKR_BOND(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ANKR_BOND(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ANKR_BOND(overrides?: CallOverrides): Promise<PopulatedTransaction>;
