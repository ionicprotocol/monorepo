...
export interface ThenaLpERC4626Interface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "GAUGES_FACTORY_VOTER",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface ThenaLpERC4626 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ThenaLpERC4626Interface;
