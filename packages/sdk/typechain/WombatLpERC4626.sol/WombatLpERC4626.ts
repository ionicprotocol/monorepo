...
export interface WombatLpERC4626Interface extends utils.Interface {
  functions: {
...
export interface WombatLpERC4626 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WombatLpERC4626Interface;
