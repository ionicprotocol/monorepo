...
export type AdminRightsToggledEvent = TypedEvent<
  [boolean],
  AdminRightsToggledEventObject
>;

export type AdminRightsToggledEventFilter =
  TypedEventFilter<AdminRightsToggledEvent>;
