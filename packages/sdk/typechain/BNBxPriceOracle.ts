...
export interface BNBxPriceOracleInterface extends utils.Interface {
  functions: {
    "BNBx()": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "BNBx", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "BNBx", data: BytesLike): Result;
...
export interface BNBxPriceOracle extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BNBxPriceOracleInterface;
  ...
  functions: {
    BNBx(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    BNBx(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    BNBx(overrides?: CallOverrides): Promise<PopulatedTransaction>;
