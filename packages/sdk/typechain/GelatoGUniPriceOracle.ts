...
export interface GelatoGUniPriceOracleInterface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic: "WTOKEN" | "getUnderlyingPrice" | "price"
  ): FunctionFragment;
...
export interface GelatoGUniPriceOracle extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GelatoGUniPriceOracleInterface;
