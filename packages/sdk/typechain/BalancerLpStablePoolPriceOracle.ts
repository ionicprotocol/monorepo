...
export interface BalancerLpStablePoolPriceOracleInterface
...
export interface BalancerLpStablePoolPriceOracle extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BalancerLpStablePoolPriceOracleInterface;
