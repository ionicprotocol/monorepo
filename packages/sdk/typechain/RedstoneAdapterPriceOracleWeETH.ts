...
export interface RedstoneAdapterPriceOracleWeETHInterface
...
export interface RedstoneAdapterPriceOracleWeETH extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RedstoneAdapterPriceOracleWeETHInterface;
