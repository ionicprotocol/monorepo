...
export declare namespace MockMiniChefV2 {
...
export interface MockMiniChefV2Interface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "saddlePerSecond",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setSaddlePerSecond",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export type LogSaddlePerSecondEvent = TypedEvent<
  [BigNumber],
  LogSaddlePerSecondEventObject
>;

export type LogSaddlePerSecondEventFilter =
  TypedEventFilter<LogSaddlePerSecondEvent>;
...
export interface MockMiniChefV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockMiniChefV2Interface;
  ...
  callStatic: {
    ...
    updatePool(
      pid: BigNumberish,
      overrides?: CallOverrides
    ): Promise<MockMiniChefV2.PoolInfoStructOutput>;
  ...
  filters: {
    ...
    "LogSaddlePerSecond(uint256)"(
      saddlePerSecond?: null
    ): LogSaddlePerSecondEventFilter;
