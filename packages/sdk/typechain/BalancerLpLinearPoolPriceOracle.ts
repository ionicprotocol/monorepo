...
export interface BalancerLpLinearPoolPriceOracleInterface
...
export interface BalancerLpLinearPoolPriceOracle extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BalancerLpLinearPoolPriceOracleInterface;
