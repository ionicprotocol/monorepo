...
export interface MockERC4626DynamicInterface extends utils.Interface {
  functions: {
...
export interface MockERC4626Dynamic extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockERC4626DynamicInterface;
