...
export interface SaddleLpPriceOracleInterface extends utils.Interface {
  functions: {
...
export interface SaddleLpPriceOracle extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SaddleLpPriceOracleInterface;
