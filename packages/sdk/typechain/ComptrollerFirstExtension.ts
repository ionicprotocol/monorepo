...
export interface ComptrollerFirstExtensionInterface extends utils.Interface {
  functions: {
...
export type MarketActionPausedEvent = TypedEvent<
  [string, string, boolean],
  MarketActionPausedEventObject
>;

export type MarketActionPausedEventFilter =
  TypedEventFilter<MarketActionPausedEvent>;

export interface MarketUnlistedEventObject {
  cToken: string;
}
export type MarketUnlistedEvent = TypedEvent<
  [string],
  MarketUnlistedEventObject
>;
...
export interface ComptrollerFirstExtension extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ComptrollerFirstExtensionInterface;
