...
export interface OptimizedAPRVaultFirstExtensionInterface
  ...
  functions: {
    ...
    "claimRewardsForUser(address)": FunctionFragment;
    ...
    "getAllFlywheels()": FunctionFragment;
    ...
    "proposeAdapters((address,uint64)[10],uint8)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getAllFlywheels",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "proposeAdapters",
    values: [AdapterConfigStruct[], BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "NewAdaptersProposed((address,uint64)[10],uint8,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "NewAdaptersProposed"): EventFragment;
...
export interface NewAdaptersProposedEventObject {
  newAdapter: AdapterConfigStructOutput[];
  adaptersCount: number;
  timestamp: BigNumber;
}
export type NewAdaptersProposedEvent = TypedEvent<
  [AdapterConfigStructOutput[], number, BigNumber],
  NewAdaptersProposedEventObject
>;

export type NewAdaptersProposedEventFilter =
  TypedEventFilter<NewAdaptersProposedEvent>;
...
export interface OptimizedAPRVaultFirstExtension extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OptimizedAPRVaultFirstExtensionInterface;
  ...
  functions: {
    ...
    getAllFlywheels(
      overrides?: CallOverrides
    ): Promise<[string[]] & { allFlywheels: string[] }>;
    ...
    proposeAdapters(
      newAdapters: AdapterConfigStruct[],
      newAdaptersCount: BigNumberish,
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
  ...
  getAllFlywheels(overrides?: CallOverrides): Promise<string[]>;
  ...
  callStatic: {
    ...
    addRewardToken(token_: string, overrides?: CallOverrides): Promise<void>;
    ...
    claimRewardsForUser(user: string, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    "NewAdaptersProposed((address,uint64)[10],uint8,uint256)"(
      newAdapter?: null,
      adaptersCount?: null,
      timestamp?: null
    ): NewAdaptersProposedEventFilter;
    NewAdaptersProposed(
      newAdapter?: null,
      adaptersCount?: null,
      timestamp?: null
  ...
  estimateGas: {
    ...
    getAllFlywheels(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getAllFlywheels(overrides?: CallOverrides): Promise<PopulatedTransaction>;
