...
export interface AutofarmERC4626Interface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: "autofarm", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "autofarm", data: BytesLike): Result;
...
export interface AutofarmERC4626 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AutofarmERC4626Interface;
  ...
  functions: {
    ...
    autofarm(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    autofarm(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    autofarm(overrides?: CallOverrides): Promise<PopulatedTransaction>;
