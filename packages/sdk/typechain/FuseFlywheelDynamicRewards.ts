...
export interface FuseFlywheelDynamicRewardsInterface extends utils.Interface {
  functions: {
...
export interface FuseFlywheelDynamicRewards extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuseFlywheelDynamicRewardsInterface;
