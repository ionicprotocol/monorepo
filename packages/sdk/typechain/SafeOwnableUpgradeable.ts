...
export interface SafeOwnableUpgradeableInterface extends utils.Interface {
  functions: {
...
export interface SafeOwnableUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SafeOwnableUpgradeableInterface;
