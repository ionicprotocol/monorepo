...
export interface EllipsisERC4626Interface extends utils.Interface {
  functions: {
    ...
    "lpTokenStaker()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "lpTokenStaker",
    values?: undefined
  ): string;
...
export interface EllipsisERC4626 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: EllipsisERC4626Interface;
  ...
  functions: {
    ...
    initialize(
      asset: string,
      _flywheel: string,
      _lpTokenStaker: string,
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;

    lpTokenStaker(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    lpTokenStaker(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    lpTokenStaker(overrides?: CallOverrides): Promise<PopulatedTransaction>;
