...
export interface RedstoneAdapterPriceOracleWrsETHInterface
...
export interface RedstoneAdapterPriceOracleWrsETH extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RedstoneAdapterPriceOracleWrsETHInterface;
