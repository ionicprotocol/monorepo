...
export interface GammaPoolBasePriceOracleInterface extends utils.Interface {
  functions: {
...
export interface GammaPoolBasePriceOracle extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GammaPoolBasePriceOracleInterface;
