...
export interface GammaPoolUniswapV3PriceOracleInterface
...
export interface GammaPoolUniswapV3PriceOracle extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GammaPoolUniswapV3PriceOracleInterface;
