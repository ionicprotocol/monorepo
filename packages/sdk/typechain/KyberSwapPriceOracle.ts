...
export interface KyberSwapPriceOracleInterface extends utils.Interface {
  functions: {
...
export interface KyberSwapPriceOracle extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: KyberSwapPriceOracleInterface;
