...
export interface ReplacingFlywheelStaticRewardsInterface
...
export interface ReplacingFlywheelStaticRewards extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ReplacingFlywheelStaticRewardsInterface;
