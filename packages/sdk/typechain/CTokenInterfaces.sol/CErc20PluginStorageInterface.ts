...
export interface CErc20PluginStorageInterfaceInterface extends utils.Interface {
  functions: {
...
export interface CErc20PluginStorageInterface extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CErc20PluginStorageInterfaceInterface;
