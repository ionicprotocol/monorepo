...
export interface CErc20AdminBaseInterface extends utils.Interface {
  functions: {
...
export interface CErc20AdminBase extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CErc20AdminBaseInterface;
