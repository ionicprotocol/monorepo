...
export interface CTokenSecondExtensionBaseInterface extends utils.Interface {
  functions: {
...
export interface CTokenSecondExtensionBase extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CTokenSecondExtensionBaseInterface;
