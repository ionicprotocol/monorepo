...
export interface CErc20PluginRewardsInterfaceInterface extends utils.Interface {
  functions: {
...
export interface CErc20PluginRewardsInterface extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CErc20PluginRewardsInterfaceInterface;
