...
export interface CErc20DelegatorBaseInterface extends utils.Interface {
  functions: {
...
export interface CErc20DelegatorBase extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CErc20DelegatorBaseInterface;
