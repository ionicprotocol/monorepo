...
export interface CTokenFirstExtensionEventsInterface extends utils.Interface {
  functions: {};
...
export interface CTokenFirstExtensionEvents extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CTokenFirstExtensionEventsInterface;
