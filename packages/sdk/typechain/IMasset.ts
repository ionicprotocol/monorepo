...
export declare namespace MassetStructs {
...
export interface IMassetInterface extends utils.Interface {
  functions: {
...
export interface IMasset extends BaseContract {
  ...
  functions: {
    ...
    getBasset(
      ...
      [
        MassetStructs.BassetPersonalStructOutput,
        MassetStructs.BassetDataStructOutput
      ] & {
        personal: MassetStructs.BassetPersonalStructOutput;
        data: MassetStructs.BassetDataStructOutput;
      }
    >;
