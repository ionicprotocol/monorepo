...
export interface ISynthereumDeploymentInterface extends utils.Interface {
  functions: {
...
export interface ISynthereumDeployment extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ISynthereumDeploymentInterface;
