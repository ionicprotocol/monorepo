...
export interface FuseFlywheelDynamicRewardsPluginInterface
...
export interface FuseFlywheelDynamicRewardsPlugin extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuseFlywheelDynamicRewardsPluginInterface;
