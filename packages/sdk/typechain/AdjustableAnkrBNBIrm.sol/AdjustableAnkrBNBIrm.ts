...
export type AnkrRateProviderParamsStruct = {
  day: BigNumberish;
  rate_provider: string;
  abond: string;
};

export type AnkrRateProviderParamsStructOutput = [number, string, string] & {
  day: number;
  rate_provider: string;
  abond: string;
};

export interface AdjustableAnkrBNBIrmInterface extends utils.Interface {
  functions: {
    "_setIrmParameters((uint256,uint256,uint256,uint256))": FunctionFragment;
    "ankrRateProviderParams()": FunctionFragment;
    ...
    "setAnkrRateProviderParams((uint8,address,address))": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "ankrRateProviderParams",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setAnkrRateProviderParams",
    values: [AnkrRateProviderParamsStruct]
  ): string;
  encodeFunctionData(
...
export interface AdjustableAnkrBNBIrm extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AdjustableAnkrBNBIrmInterface;
  ...
  estimateGas: {
    ...
    ankrRateProviderParams(overrides?: CallOverrides): Promise<BigNumber>;
