...
export interface CErc20RewardsDelegateInterface extends utils.Interface {
  functions: {
...
export interface CErc20RewardsDelegate extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CErc20RewardsDelegateInterface;
