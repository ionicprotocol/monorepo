import { FlywheelRewardsInfoForVault, FundOperationMode, LeverageData, SupportedChains } from "@midas-capital/types";
...
export function withLeverage<TBase extends CreateContractsModule = CreateContractsModule>(Base: TBase) {
  return class Leverage extends Base {
    async getAllLeveredPositions(): Promise<LeverageData[]> {
