...
locals {
  ...
  bsc_mainnet_rpc_1          = "https://speedy-nodes-nyc.moralis.io/${var.moralis_api_key}/bsc/mainnet"
  ...
  moonbeam_mainnet_rpc_2          = "https://moonbeam-mainnet.gateway.pokt.network/v1/lb/${var.pokt_api_key}"
